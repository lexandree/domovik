...
class ControlPanelWindow(QWidget):
    def __init__(
        ...
        self.capture_value_label = QLabel("none")
        ...
        self.capture_value_label.setWordWrap(True)
        ...
        status_grid.addWidget(QLabel("Details"), 2, 0)
        status_grid.addWidget(self.details_value_label, 2, 1)
        status_grid.addWidget(QLabel("Last capture"), 3, 0)
        status_grid.addWidget(self.capture_value_label, 3, 1)
        status_grid.addWidget(QLabel("Push-to-talk"), 4, 0)
        status_grid.addWidget(self.push_to_talk_value_label, 4, 1)
        status_grid.addWidget(QLabel("Hotkey backend"), 5, 0)
        status_grid.addWidget(self.hotkey_backend_value_label, 5, 1)
        status_grid.addWidget(QLabel("Shortcut"), 6, 0)
        status_grid.addWidget(self.shortcut_value_label, 6, 1)
        status_grid.addWidget(QLabel("Speech"), 7, 0)
        status_grid.addWidget(self.speech_value_label, 7, 1)
    ...
    def refresh_labels(self, runtime_summary: str, runtime_details: str, runtime_process_summary: str) -> None:
    ...
    def set_capture_summary(self, capture_summary: str) -> None:
        self.capture_value_label.setText(capture_summary)
