...
**Tests**: The examples below include test tasks. Automated tests are OPTIONAL
unless the feature specification demands them, but validation tasks are NOT
optional for material runtime, shell, screenshot, routing, or voice changes.
...
- [ ] T010 Document required local verification commands and deferred checks
...
- [ ] T019 [US1] Run and record the required syntax/runtime/UI verification for touched paths
...
- [ ] T026 [US2] Run and record the required syntax/runtime/UI verification for touched paths
...
- [ ] T032 [US3] Run and record the required syntax/runtime/UI verification for touched paths
...
- [ ] TXXX Update guidance files (`AGENTS.md`, localized guidance, setup docs) if structure or run flow changed
